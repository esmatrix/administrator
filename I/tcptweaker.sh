...
then
	echo ""
	echo "Las configuraciones de red TCP Tweaker já foram adicionadas no sistema!"
	echo ""
...
sysctl -p /etc/sysctl.conf > /dev/null
		echo ""
		echo "Las configuraciones de red de TCP Tweaker foram removidas com sucesso."
		echo ""
	exit
	else 
		echo ""
	...
	echo "Este script irá alterar algumLas configuraciones de red"
...
sysctl -p /etc/sysctl.conf
		echo ""
		echo "Las configuraciones de red de TCP Tweaker foram adicionadas com sucesso."
		echo ""
	else
		echo ""
